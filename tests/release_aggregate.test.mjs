// All ordered checkpoints must succeed before completion is reachable.
"use strict";
...
assert.deepEqual(names, ["version-check", "package", "publish", "native-exact", "verify-exact", "promote-channels", "native-default", "verify-channels"]);
...
console.log("release_aggregate.test: native and aggregate checkpoint dependency and receipt completion contracts verified");
