...
- Built-in AST metrics cover Rust, JavaScript/TypeScript/TSX, Python, and Go.
  C/C++ is not advertised as supported. Distribution is six Linux/macOS
  archives and npm platform packages; Windows, Homebrew, and cargo-dist are not
  release channels for 0.5.0.
